...
username="${1}"
url="http://10.11.249.0/" # a mettre à jour avec l'adresse IP de la machine cible
password_file="./rockyou.txt.gz" # a mettre à jour avec le chemin du fichier de mots de passe
